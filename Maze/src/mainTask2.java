...
public class mainTask2 extends JFrame implements KeyListener{
    ...
    //set exit icon
    public static ImageIcon icon3 = new ImageIcon("exit.png");
    public static Image img3 = icon3.getImage();
    public static Image newimg3=img3.getScaledInstance(20, 20, Image.SCALE_SMOOTH); //set size
    public static ImageIcon exit=new ImageIcon(newimg3);
    ...
    public mainTask2(){
        ...
        do{
            ...
            //prevent spawn on wall and exit
